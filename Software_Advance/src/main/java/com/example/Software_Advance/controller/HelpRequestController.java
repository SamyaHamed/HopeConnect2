...
public class HelpRequestController {
    ...
    public List<HelpRequest> getHelpRequestsByTitle(@PathVariable String title) {
        return helpRequestService.getHelpRequestsByTitle(title);
    }


    @PostMapping
    public ResponseEntity<?> addHelpRequest(@RequestBody HelpRequestDto helpRequestDTO) {
        try {
